...
#ifndef WIN32
#define HUGE_BUF_LEN	0x2300 //(sizeof(RspRcv02)+32) //2034
#else
...
static void Init_ADC()
{
	...
	ADC->MR		= ADC_TRANSFER(2)|ADC_TRACKTIM(~0)|ADC_SETTLING_AST17|ADC_STARTUP_960|ADC_PRESCAL(~0)|ADC_FREERUN;	// 0x2F3FFF80 //0x0001FF80;
	ADC->ACR	= 0;//ADC_TSON;
...
#ifdef MAN_TRANSMIT_SSC_asdasdasd
